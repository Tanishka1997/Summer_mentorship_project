   ...
   RecyclerView recyclerView_monday;
    ...
    public void deleting_it(){
            ...
            for (int i = 0; i < day_events.size(); i++) {
                h = (EventHolder) recyclerView_monday.findViewHolderForAdapterPosition(i);
                if (h.relativeLayout.isSelected()) {
                    ...
                    data.delete_it("Monday", event_name, from_hour, from_minute, to_hour, to_minute);
                } else
        ...
        switch (item.getItemId()){
            case R.id.delete_it: {
                ...
                if (num != 0) {
                    ...
                    deleteDialog.setTargetFragment(Monday.this, 1);
                    ...
                    selectHow.setTargetFragment(Monday.this, 6);
                    selectHow.show(manager, "Monday_Message");
                    return true;
                }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView_monday=(RecyclerView) v.findViewById(R.id.monday_recycler_view);
        recyclerView_monday.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    public void launch()
    {
       day_events=eventLab.getEvent_list();
        ...
        recyclerView_monday.setAdapter(adapter);
    }
