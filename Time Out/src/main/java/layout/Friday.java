...
public class Friday extends Fragment {
    ...
    public void deleting_it(){
        ...
        for(int i=0;i<day_events.size();i++) {
            h = (EventHolder) recyclerView_friday.findViewHolderForAdapterPosition(i);
            if (h.relativeLayout.isSelected()) {
                ...
                data.delete_it("Friday",event_name,from_hour,from_minute,to_hour,to_minute);
            }
            else
        ...
        {  day_events=my_day_events;
            ...
            recyclerView_friday.setAdapter(eventAdapter);}
    }
    @Override
        ...
        switch (item.getItemId()){
            case R.id.delete_it: {
                ...
                if (num != 0) {
                    ...
                    deleteDialog.setTargetFragment(Friday.this, 5);
                    ...
                    selectHow.setTargetFragment(Friday.this, 10);
                    selectHow.show(manager, "Friday_Message");
                    return true;
                }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView_friday=(RecyclerView) v.findViewById(R.id.friday_recycler_view);
        recyclerView_friday.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    public void launch()
    {
        ...
        recyclerView_friday.setAdapter(adapter);
    }
