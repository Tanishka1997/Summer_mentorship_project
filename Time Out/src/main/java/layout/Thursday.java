...
public class Thursday extends Fragment {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK) {
            ...
            for (int i = 0; i < day_events.size(); i++) {
                h = (EventHolder) recyclerView_thursday.findViewHolderForAdapterPosition(i);
    ...
    public void deleting_it(){
        ...
        for(int i=0;i<day_events.size();i++) {
            ...
            if (h.relativeLayout.isSelected()) {
                ...
                data.delete_it("Thursday",event_name,from_hour,from_minute,to_hour,to_minute);
            }
            else
        ...
        {  day_events=my_day_events;
            ...
            recyclerView_thursday.setAdapter(eventAdapter);}
    }
    @Override
        ...
        switch (item.getItemId()){
            case R.id.delete_it: {
                ...
                if (num != 0) {
                    ...
                    deleteDialog.setTargetFragment(Thursday.this, 4);
                    ...
                    selectHow.setTargetFragment(Thursday.this, 9);
                    selectHow.show(manager, "Thursday_Message");
                    return true;
                }
    ...
    @Override
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            recyclerView_thursday=(RecyclerView) v.findViewById(R.id.thursday_recycler_view);
            recyclerView_thursday.setLayoutManager(new LinearLayoutManager(getActivity()));
        ...
        public void launch()
        {
            ...
            recyclerView_thursday.setAdapter(adapter);
        }
