...
public class Tuesday extends Fragment {
    ...
    public void deleting_it() {
            ...
            for (int i = 0; i < day_events.size(); i++) {
                h = (EventHolder) recyclerView_tuesday.findViewHolderForAdapterPosition(i);
                if (h.relativeLayout.isSelected()) {
                    ...
                    data.delete_it("Tuesday", event_name, from_hour, from_minute, to_hour, to_minute);
                } else
            ...
            if (dell == 1) {
                ...
                recyclerView_tuesday.setAdapter(eventAdapter);
            }
        ...
        switch (item.getItemId()){
            case R.id.delete_it: {
                ...
                if (num != 0) {
                    ...
                    deleteDialog.setTargetFragment(Tuesday.this, 2);
                    ...
                    selectHow.setTargetFragment(Tuesday.this, 7);
                    selectHow.show(manager, "Tuesday_Message");
                    return true;
                }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView_tuesday=(RecyclerView) v.findViewById(R.id.tuesday_recycler_view);
        recyclerView_tuesday.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    public void launch()
    {
        ...
        recyclerView_tuesday.setAdapter(adapter);
    }
